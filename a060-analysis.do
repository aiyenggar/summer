...
replace ct_inventor_region="Austin-Round Rock" if ct_inventor_region=="Austin-Round Rock, TX"
replace ct_inventor_region="Boston-Cambridge-Newton" if ct_inventor_region=="Boston-Cambridge-Newton, MA-NH"
replace ct_inventor_region="San Francisco-Oakland-Hayward" if ct_inventor_region=="San Francisco-Oakland-Hayward, CA"
replace ct_inventor_region="San Jose-Sunnyvale-Santa Clara" if ct_inventor_region=="San Jose-Sunnyvale-Santa Clara, CA"
...
gen nla = round(sumla*100/yr_reg_total)
label variable nla "Local-Internal"
gen nlap = round(sumlap*100/yr_reg_total)
label variable nlap "Local-External"
gen nlpa = round(sumlpa*100/yr_reg_total)
label variable nlpa "Non-Local-Internal"
gen nlpap = round(sumlpap*100/yr_reg_total)
...
gen cgaustin = 1 if cg_inventor_region=="Austin-Round Rock"
replace cgaustin = 0 if missing(cgaustin)
label variable cgaustin "Citing Region = Austin"

gen ctaustin = 1 if ct_inventor_region=="Austin-Round Rock"
